...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            {"custom_reports": '[{"name": "daily_active_users", "metrics": ["totalUsers"], "dimensions": [{"name": "city"}]}]'},
            Status.FAILED,
        ...
        (
            ...
            Status.FAILED,
            "'custom_reports: daily_active_users already exist as a default report(s).'",
        ),
        (
        ...
        (
            ...
            Status.FAILED,
            "\"custom_reports.0.cohortSpec.cohortsRange: 'granularity' is a required property\"",
        ),
        (
            {
